...
CLASS LHC_ZI_ERRORCODE_S_907 IMPLEMENTATION.
  METHOD AUGMENT.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE ZI_ErrorCode_907\_ErrorCodeText,
          text_for_existing_entity TYPE TABLE FOR CREATE ZI_ErrorCode_907\_ErrorCodeText,
          text_update              TYPE TABLE FOR UPDATE ZI_ErrorCodeText_907.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK ZI_ErrorCode_907\_ErrorCodeText,
    ...
    ENDLOOP.
    MODIFY AUGMENTING ENTITIES OF ZI_ErrorCode_S_907
      ENTITY ErrorCode
    ...
    IF entities_update IS NOT INITIAL.
      READ ENTITIES OF ZI_ErrorCode_S_907
